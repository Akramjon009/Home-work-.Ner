    ...
    private static async Task Main(string[] args)
    {
        ...
        async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
        {
            ...
            if (messageText != null && int.Parse(day.ToString()) >= day && int.Parse(hour.ToString()) >= hour && int.Parse(minute.ToString()) >= minute && int.Parse(second.ToString()) >= second - 10)
            {
                ...
                var getchatmember = await botClient.GetChatMemberAsync(/*ID or NAME of the chat*/"@Abduvahobov09",/*user id*/ id);
                //var getchatmember2 = await botClient.GetChatMemberAsync(/*ID or NAME of the chat*/"@muhammadabdulloh_uz",/*user id*/ id);


                // shunaqa qilib bir nechta kanallarni tekshirvolorasiz
                ...
                else
                {
                    ...
                    if (messageText == "meme")
                    {
                        ...
                        chatId: chatId,
                        photo: InputFile.FromUri("https://i.redd.it/uhkj4abc96r61.jpg"),
                        caption: "<b>MEME</b>",
                    ...
                    if (messageText == "album")
                    {
                        ...
                        {
                    new InputMediaPhoto( InputFile.FromUri("https://cdn.pixabay.com/photo/2017/06/20/19/22/fuchs-2424369_640.jpg")),
                    new InputMediaPhoto(InputFile.FromUri("https://cdn.pixabay.com/photo/2017/04/11/21/34/giraffe-2222908_640.jpg")),
                        },
                        cancellationToken: cancellationToken);
                    }
